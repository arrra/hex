/// Port of .hex/scripts/hex-fleet/install.sh
/// Installs the Hex Fleet Manager as a macOS LaunchAgent.
use std::path::PathBuf;
use std::process::Command;

const PLIST_NAME: &str = "com.hex.fleet-manager.plist";
const PLIST_REL: &str = ".hex/scripts/hex-fleet/com.hex.fleet-manager.plist";
...
pub fn run_install(hex_dir: &PathBuf) {
    ...
    println!("Hex Fleet Manager installed and running");
    println!("Logs: ~/.boi/pm/fleet-manager.stdout.log");
}
...
mod tests {
    ...
    fn plist_path_construction() {
        ...
        assert_eq!(
            ...
            "/Users/test/hex/.hex/scripts/hex-fleet/com.hex.fleet-manager.plist"
        );
    }
    ...
    fn plist_dst_construction() {
        ...
        assert_eq!(
            dst.to_str().unwrap(),
            "/Users/test/Library/LaunchAgents/com.hex.fleet-manager.plist"
        );
    }
}

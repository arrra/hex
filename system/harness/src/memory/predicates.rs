...
mod tests {
    ...
    fn all_entries_present() {
        let expected = [
            "is", "alternateName", "homeLocation", "born-on",
            "prefers", "dislikes", "values", "avoids",
            "current-focus", "status", "blocked-by", "available-at",
            "works-on", "decided", "responsible-for", "committed-to",
            "knows", "knowsAbout", "learned-that",
            "related-to", "recipient-of",
            "has", "plans-to",
            "_unmapped",
        ];
        for e in &expected {
